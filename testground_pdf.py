...
def ingest(files: List[str], storage_context: StorageContext) -> KnowledgeGraphIndex:
    file_extractor = {
    ...
    kg_index = KnowledgeGraphIndex.from_documents([], storage_context=storage_context)
    for file in files:
...
index = ingest(["example_data_2/toolformer-2302.04761.pdf"], storage_context)
